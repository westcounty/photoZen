...
class GuideStateTest {
    ...
    fun `GuideSequenceState isActive when currentGuide is not null`() {
        val state = GuideSequenceState(
            currentGuide = GuideKey.SWIPE_RIGHT,
            currentStep = 1,
            totalSteps = 3,
            dismissCurrent = { },
            skipAll = { }
    ...
    fun `GuideSequenceState step information is correct`() {
        val state = GuideSequenceState(
            currentGuide = GuideKey.SWIPE_LEFT,
            currentStep = 2,
            totalSteps = 3,
            dismissCurrent = { },
            skipAll = { }
        ...
        assertEquals(GuideKey.SWIPE_LEFT, state.currentGuide)
    }
    ...
    fun `GuideSequenceState at final step`() {
        val state = GuideSequenceState(
            currentGuide = GuideKey.SWIPE_UP,
            currentStep = 3,
            totalSteps = 3,
            dismissCurrent = { },
            skipAll = { }
    ...
    fun `GuideSequenceState copy works correctly`() {
        ...
        val copied = state.copy(currentStep = 2, currentGuide = GuideKey.SWIPE_LEFT)
        
        assertEquals(GuideKey.SWIPE_LEFT, copied.currentGuide)
