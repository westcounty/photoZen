...
### 修复
- **彻底修复Flow筛选**：
  - 首页显示的待整理数量现在正确根据筛选条件计算
  - 添加相机相册加载状态标志，确保筛选在数据加载完成后才生效
  - 修复相机模式/排除相机模式在相册ID未加载时错误显示全部照片的问题
- **增强相机相册识别**：扩展识别规则，覆盖更多设备和命名约定（OpenCamera、Gcam、Screenshots等）
...
### 修复
- **Flow筛选条件彻底修复**：将自定义筛选条件改为响应式 StateFlow，确保筛选设置实时生效
- **CUSTOM模式正确导航**：设置为"每次整理前选择"时，点击快速整理会正确跳转到筛选选择界面
