...
<p align="center">
  <img src="https://img.shields.io/badge/Version-1.5.0.001-blue" alt="Version">
...
### v1.5.0.001 (2026-01-18)
📅 **时间线功能！**

- **时间线浏览**：照片按时间自动分组，支持智能/按天/按月/按年模式
- **整理进度显示**：每个分组显示"已整理/总数"统计
- **快速整理入口**：点击分组按钮直接进入该时间段整理
...
包含所有核心功能：滑动整理、照片对比、标签气泡、无损编辑、一条龙整理、成就系统、智能筛选、批量管理等。
